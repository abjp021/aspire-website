          ...
          <foreignObject x="0" y="100" width="1600" height="50">
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%' }}>
              ...
              <div style={{ display: 'flex', gap: '2rem', justifyContent: 'center', marginTop: '0.5rem' }}>
                <a href="/privacy" style={{ color: '#fff', fontWeight: 600, textDecoration: 'underline', textUnderlineOffset: 5, fontSize: '1rem', textShadow: '0 1px 4px #0a2a5c', transition: 'text-decoration-color 0.2s', textDecorationColor: 'rgba(255,255,255,0.5)' }} onMouseOver={e => e.currentTarget.style.textDecorationColor = '#fff'} onMouseOut={e => e.currentTarget.style.textDecorationColor = 'rgba(255,255,255,0.5)'}>Privacy Policy</a>
                <a href="/terms" style={{ color: '#fff', fontWeight: 600, textDecoration: 'underline', textUnderlineOffset: 5, fontSize: '1rem', textShadow: '0 1px 4px #0a2a5c', transition: 'text-decoration-color 0.2s', textDecorationColor: 'rgba(255,255,255,0.5)' }} onMouseOver={e => e.currentTarget.style.textDecorationColor = '#fff'} onMouseOut={e => e.currentTarget.style.textDecorationColor = 'rgba(255,255,255,0.5)'}>Terms of Service</a>
              </div>
            </div>
          </foreignObject>
        </svg>
